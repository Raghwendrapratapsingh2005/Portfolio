      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col space-y-6 text-left">
          ...
          <div className="space-y-4">
            {/* Email link */}
            <a
              href="mailto:raghwendrapratapsingh86@gmail.com"
            ...
            >
              ...
              <div>
                ...
                <span className="text-sm sm:text-base font-semibold">raghwendrapratapsingh86@gmail.com</span>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <span className="text-sm sm:text-base font-semibold">9798656957</span>
              </div>
            </a>
