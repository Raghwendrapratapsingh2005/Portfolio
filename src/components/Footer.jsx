...
export default function Footer({ darkMode }) {
  ...
  const socialLinks = [
    { icon: <Linkedin className="w-4 h-4" />, url: 'https://www.linkedin.com/in/raghwendra-pratap-singh-76b0b0/', colorClass: 'hover:text-cyber-cyan hover:shadow-neon-cyan hover:border-cyber-cyan' },
    { icon: <Github className="w-4 h-4" />, url: 'https://github.com/Raghwendrapratapsingh2005', colorClass: 'hover:text-violet-400 hover:shadow-neon-violet hover:border-violet-500' },
  ];
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-center md:items-start space-y-1">
          <span className={`text-base font-bold tracking-wider ${
            ...
            RAGHWENDRA<span className="text-neon-magenta font-extrabold">.DEV</span>
          </span>
          <p className="text-xs font-mono">
            © 2026 Raghwendra Pratap Singh. All rights reserved.
          </p>
        </div>
