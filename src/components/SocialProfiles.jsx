...
export default function SocialProfiles({ darkMode }) {
  const profiles = [
    {
      name: 'LinkedIn',
      username: '@raghwendra-pratap-singh-76b0b0363',
      url: 'https://www.linkedin.com/in/raghwendra-pratap-singh-76b0b0363/?skipRedirect=true',
    ...
    {
      name: 'GitHub',
      username: '@Raghwendrapratapsingh2005',
      url: 'https://github.com/Raghwendrapratapsingh2005',
